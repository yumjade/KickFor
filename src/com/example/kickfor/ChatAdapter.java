	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			if(isMyMsg==true){
				...
				rightViewHolder.message.setOnLongClickListener(new OnLongClickListener(){
						...
						builder.setAdapter(catalogsAdapter, new DialogInterface.OnClickListener(){
						    public void onClick(DialogInterface arg0, int arg1) {
						        if(arg1==0){
						        	...
						        	//删除当前会话的某条聊天记录
						        	EMConversation conversation = EMChatManager.getInstance().getConversation(entity.getPhone());
						        	conversation.removeMessage(entity.getMsgId());
						        	list.remove(entity);
				...
				leftViewHolder.message.setOnLongClickListener(new OnLongClickListener(){
