...
public class MatchLogAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.totalGoal = (TextView) convertView
					.findViewById(R.id.match_total_goal);
			viewHolder.totalLost = (TextView) convertView
					.findViewById(R.id.match_total_lost);
			viewHolder.b = (LinearLayout) convertView
					.findViewById(R.id.match_log_b);
			viewHolder.margin = (TextView) convertView
					.findViewById(R.id.match_log_margin);
