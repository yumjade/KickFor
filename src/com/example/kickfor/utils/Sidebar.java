...
import com.example.kickfor.FriendsAdapter;
import com.example.kickfor.R;
import com.example.kickfor.R.drawable;
import com.example.kickfor.R.id;
import com.example.kickfor.R.string;
...
public class Sidebar extends View{
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		 if (mListView == null) {
			 ...
			 System.out.println("ddddfffffwwwwww");
		        return;
		    }
		...
		try {
			for (int i = adapterSections.length - 1; i > -1; i--) {
				System.out.println(adapterSections[i]);
