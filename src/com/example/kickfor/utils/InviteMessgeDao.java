...
import com.example.kickfor.utils.InviteMessage;
...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return KickforDBManager.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
	    KickforDBManager.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return KickforDBManager.getInstance().getMessagesList();
	}
	
	public void deleteMessage(String from){
	    KickforDBManager.getInstance().deleteMessage(from);
	}
}
