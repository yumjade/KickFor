...
public class SexangleView2 extends View {
	...
	public SexangleView2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public SexangleView2(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public void getDot() {
		...
		px=Tools.dip2px(getContext(), 4.5f);
