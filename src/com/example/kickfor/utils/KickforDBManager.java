...
import com.example.kickfor.utils.InviteMessage.InviteMesageStatus;
import com.easemob.util.HanziToPinyin;

public class KickforDBManager {
    static private KickforDBManager dbMgr = new KickforDBManager();
    ...
    public static synchronized KickforDBManager getInstance(){
        return dbMgr;
    }
